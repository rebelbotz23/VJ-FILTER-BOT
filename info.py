...
BOT_TOKEN = environ.get('BOT_TOKEN', "8115651486:AAGHeG6s20wX-ocrCD7Dq7wLW0Jo9CaBUts")
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6519657922').split()]  # For Multiple Id Use One Space Between Each.
AUTH_USERS = (auth_users + ADMINS) if auth_users else []

# This Channel Is For When User Start Your Bot Then Bot Send That User Name And Id In This Log Channel, Same For Group Also.
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002365608258'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002006948824') # give your force subscribe channel id here else leave it blank
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/RJMoviessWorld') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/RJworld2')
